...
import { readJsonFile, scenesFilePath, sceneClipPath } from '@/lib/utils/file-utils';
...
export async function GET(
  ...
  try {
    ...
    for (const moment of session.moments) {
      ...
      const filePath = sceneClipPath(sessionId, moment.id, scene.indexInMoment);
    ...
    logger.error('Clip serve error', { sessionId, sceneId, error: msg });
